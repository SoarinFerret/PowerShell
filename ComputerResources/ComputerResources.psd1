@{
    RootModule = 'ComputerResources.psm1'
    ModuleVersion = '0.0.1'
    GUID = '8df3d09c-99bd-4a4a-b144-49197a269450'
    Author = 'Cody Ernesti'
    Copyright = '(c) 2020 Cody Ernesti. All rights reserved.'
    Description = 'Retrieve computer resources between Windows boxes using CIM Instances'
